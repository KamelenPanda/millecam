  ...
  return (
    <>
      ...
      <Section className="bg-white pt-10">
        <h2 className="font-serif text-3xl font-semibold text-ink">Onze diensten</h2>
        <RevealGroup
      ...
      <Section className="hidden bg-white py-8 md:block">
        <p className="text-xs font-semibold uppercase tracking-wide text-ink/40">Kaders</p>
        <div className="mt-5">
          <FrameworkStrip
      ...
      <Section>
        ...
        <Link href="/cases" className="mt-8 inline-block text-sm font-medium text-terracotta hover:underline">
