 ...
 * className (e.g. "h-4 w-3"); defaults to currentColor-independent prussian.
 */
export default function PillarGlyph({ className = "h-4 w-3", color = "#16323B" }: PillarGlyphProps) {
  return (
