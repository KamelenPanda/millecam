      ...
      {stappen.map((s, i) => (
        ...
        >
          <div className="flex flex-col items-center">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-prussian-deep font-serif text-sm font-bold text-paper">
              {s.nummer}
            </span>
            {i < stappen.length - 1 && (
              <div
          ...
          <div className="flex flex-1 flex-wrap items-center justify-between gap-4 border-l-2 border-prussian bg-[#F4F5F2] py-7 pl-6 pr-5 shadow-[0_14px_34px_rgba(20,24,29,0.09)]">
            <div>
