...
export default function IllustrationDialogue({ className = "h-24 w-24" }: Props) {
  return (
    <svg viewBox="0 0 120 120" className={className} aria-hidden="true">
      <rect x="14" y="24" width="70" height="46" rx="10" fill="#D6D9D4" />
      <rect x="40" y="52" width="66" height="42" rx="10" fill="#16323B" />
      <circle cx="58" cy="73" r="4" fill="#EDEEE9" />
      <circle cx="72" cy="73" r="4" fill="#EDEEE9" />
      <circle cx="86" cy="73" r="4" fill="#EDEEE9" />
    </svg>
  );
}
